# Required input
Charmm36FF=/path/to/share/gromacs/top/charmm36-jul2022.ff
...
# Using the Amber99SB-ILDN force field is selected
# Generate system topology
echo "; Include forcefield parameters
#include \"$Charmm36FF/forcefield.itp\"
#include \"$LIGTop\"

; Include water topology
#include \"$Charmm36FF/tip3p.itp\"
...
[ molecules ]
$LIG    1
" > $WorkDir/HighEnergySampling/PDB2GMX/system.top
...
$GMX editconf -f $LIGStrct -o $WorkDir/HighEnergySampling/Solvation/Box.pdb -bt dodecahedron -d 2.5 -c

$GMX solvate -cp $WorkDir/HighEnergySampling/Solvation/Box.pdb -cs spc216.gro -p $WorkDir/HighEnergySampling/PDB2GMX/system.top -o $WorkDir/HighEnergySampling/Solvation/solv.gro
...
$GMX grompp -f $WorkDir/HighEnergySampling/Solvation/ions.mdp -c $WorkDir/HighEnergySampling/Solvation/solv.gro -r $WorkDir/HighEnergySampling/Solvation/solv.gro -p $WorkDir/HighEnergySampling/PDB2GMX/system.top -o $WorkDir/HighEnergySampling/Solvation/ions.tpr -maxwarn 1

echo "SOL" | $GMX genion -s $WorkDir/HighEnergySampling/Solvation/ions.tpr -o $WorkDir/HighEnergySampling/Solvation/solv_ions.gro -p $WorkDir/HighEnergySampling/PDB2GMX/system.top -pname NA -nname CL -neutral -conc 0.15
...
$GMX grompp -f $WorkDir/HighEnergySampling/EM/em.mdp -c $WorkDir/HighEnergySampling/Solvation/solv_ions.gro -r $WorkDir/HighEnergySampling/Solvation/solv_ions.gro -p $WorkDir/HighEnergySampling/PDB2GMX/system.top -o $WorkDir/HighEnergySampling/EM/em.tpr
...
ref_t                   = 398                           ; reference temperature, one for each group, in K
; Pressure coupling
...
$GMX grompp -f $WorkDir/HighEnergySampling/NVT/nvt.mdp -c $WorkDir/HighEnergySampling/EM/confout.gro -r $WorkDir/HighEnergySampling/EM/confout.gro -p $WorkDir/HighEnergySampling/PDB2GMX/system.top -o $WorkDir/HighEnergySampling/NVT/nvt.tpr
...
$GMX grompp -f $WorkDir/HighEnergySampling/NPT/npt.mdp -c $WorkDir/HighEnergySampling/NVT/confout.gro -r $WorkDir/HighEnergySampling/NVT/confout.gro -p $WorkDir/HighEnergySampling/PDB2GMX/system.top -o $WorkDir/HighEnergySampling/NPT/npt.tpr
...
$GMX grompp -f $WorkDir/HighEnergySampling/MD/md.mdp -c $WorkDir/HighEnergySampling/NPT/confout.gro -r $WorkDir/HighEnergySampling/NPT/confout.gro -p $WorkDir/HighEnergySampling/PDB2GMX/system.top -o $WorkDir/HighEnergySampling/MD/md.tpr
...
echo "Other" "Other" | $GMX trjconv -f $WorkDir/HighEnergySampling/MD/traj_comp.xtc -s $WorkDir/HighEnergySampling/MD/md.tpr -o $WorkDir/HighEnergySampling/MD/FixPBC/md_nojump.xtc -center -pbc nojump 

echo "Other" | $GMX trjconv -f $WorkDir/HighEnergySampling/MD/FixPBC/md_nojump.xtc -s $WorkDir/HighEnergySampling/MD/md.tpr -o $WorkDir/HighEnergySampling/MD/FixPBC/md_nojump_whole.xtc -pbc whole 

echo "Other" "Other" | $GMX trjconv -f $WorkDir/HighEnergySampling/MD/FixPBC/md_nojump_whole.xtc -s $WorkDir/HighEnergySampling/MD/md.tpr -o $WorkDir/HighEnergySampling/MD/FixPBC/md_nojump_whole_fit.xtc -fit rot+trans 

echo "Other" | $GMX trjconv -f $WorkDir/HighEnergySampling/MD/FixPBC/md_nojump_whole_fit.xtc -s $WorkDir/HighEnergySampling/MD/md.tpr -dump 0 -o $WorkDir/HighEnergySampling/MD/FixPBC/frame0.pdb 

rm $WorkDir/HighEnergySampling/MD/FixPBC/md_nojump_whole.xtc $WorkDir/HighEnergySampling/MD/FixPBC/md_nojump.xtc
...
do
	...
	$GMX grompp -f $WorkDir/MultiSimulations/MDPFile/nvt.mdp -c $WorkDir/StartingConformations/frame_$i.pdb -r $WorkDir/StartingConformations/frame_$i.pdb -p $WorkDir/HighEnergySampling/PDB2GMX/system.top -o $WorkDir/MultiSimulations/frame_$i/NVT/nvt.tpr
...
do
	...
	$GMX grompp -f $WorkDir/MultiSimulations/MDPFile/npt.mdp -c $WorkDir/MultiSimulations/frame_$i/NVT/confout.gro -r $WorkDir/MultiSimulations/frame_$i/NVT/confout.gro -p $WorkDir/HighEnergySampling/PDB2GMX/system.top -o $WorkDir/MultiSimulations/frame_$i/NPT/npt.tpr
...
do
	...
	$GMX grompp -f $WorkDir/MultiSimulations/MDPFile/md.mdp -c $WorkDir/MultiSimulations/frame_$i/NPT/confout.gro -r $WorkDir/MultiSimulations/frame_$i/NPT/confout.gro -p $WorkDir/HighEnergySampling/PDB2GMX/system.top -o $WorkDir/MultiSimulations/frame_$i/MD/md.tpr
